...
public class DefaultMappingTypeValidator
    implements ConstraintValidator<ValidDefaultMappingType, ExternalIdentifierDefinition> {

  @Override
  public boolean isValid(
      ExternalIdentifierDefinition externalIdentifierDefinition,
      ConstraintValidatorContext context) {
    if (externalIdentifierDefinition.getDefaultMappingType() == null) {
      return true; // If defaultMappingType is not set, no validation needed
    }
    return externalIdentifierDefinition
        .getMappingTypes()
        .contains(externalIdentifierDefinition.getDefaultMappingType());
  }
}
