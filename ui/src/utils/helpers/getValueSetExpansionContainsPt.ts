...
export function convertFromValueSetExpansionContainsListToSnowstormConceptMiniList(valueSet: ValueSetExpansionContains[]) : Concept[]{
    return valueSet.map(value => {
        return convertFromValueSetExpansionContainsToSnowstormConceptMini(value)
    });
}
export function convertFromValueSetExpansionContainsToSnowstormConceptMini(valueSet: ValueSetExpansionContains) : Concept {
...
export function generateFsnFromValueSetExpansionContains(valueSet: ValueSetExpansionContains) : Term {
...
export function generatePtFromValueSetExpansionContains(valueSet: ValueSetExpansionContains) : Term {
