...
const AutoCompleteField = ({
    ...
    useEffect(() => {
        if (formData) {
            const selectedOption = options.find((option) => option.conceptId === formData.conceptId);
    ...
    return (
        <div>
            ...
            <Autocomplete
                ...
                value={options.find((option) => option.conceptId === formData?.conceptId) || null}
                onInputChange={(event, newInputValue) => setInputValue(newInputValue)}
                onChange={(event, selectedValue) => handleProductChange(selectedValue as Concept)}
