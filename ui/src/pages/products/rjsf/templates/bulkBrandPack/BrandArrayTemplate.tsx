                ...
                {items.map((item, index) =>
                    item.children.props.formData.brand ? (
                        ...
                        >
                            ...
                            <Box>
                                <ListItemText primary={item.children.props.formData.brand.pt?.term} />
                                <FieldChips
                                    items={sortExternalIdentifiers(item.children.props.formData.externalIdentifiers)}
                                />
                            </Box>
                        </ListItem>
                    ) : null
