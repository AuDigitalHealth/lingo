...
public class AllowedValuesValidator
    implements ConstraintValidator<ValidAllowedValues, NonDefiningProperty> {

  @Override
  public boolean isValid(NonDefiningProperty property, ConstraintValidatorContext context) {
