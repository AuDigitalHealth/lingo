...
b.  **Backlog Tables:** A condensed view of the work tickets with specific filters available. Users
...
2. A ticket can be manually created by clicking on the ***Create Ticket*** button.
...
4. If the ticket is ready for authoring, a Task can be added in the same window by clicking the
   ***Add Task*** button.
